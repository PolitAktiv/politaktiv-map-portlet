...
/**
 * The interface for the db marker local service.
 *
 * <p>
...
public interface DbMarkerLocalService extends PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DbMarkerLocalServiceUtil} to access the db marker local service. Add custom service methods to {@link org.politaktiv.map.infrastructure.service.impl.DbMarkerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public DbMarker createDbMarker(
		long markerId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DbMarker> getDbMarkers(
		int start, int end)
		throws SystemException;
	...
	* @throws SystemException if a system exception occurred
	*/
	public DbMarker updateDbMarker(
		DbMarker dbMarker)
		throws SystemException;
