 ...
 * @generated
 */
public abstract class MarkerActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public MarkerActionableDynamicQuery() throws SystemException {
		setBaseLocalService(MarkerLocalServiceUtil.getService());
		setClass(Marker.class);

		setClassLoader(org.politaktiv.map.infrastructure.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("markerId");
	}
}