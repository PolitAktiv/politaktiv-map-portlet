...
/**
 * Provides the local service utility for Marker. This utility wraps
 * {@link org.politaktiv.map.infrastructure.service.impl.MarkerLocalServiceImpl} and is the
...
public class MarkerLocalServiceUtil {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static org.politaktiv.map.infrastructure.model.Marker deleteMarker(
		long markerId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteMarker(markerId);
	}
	...
	*/
	public static org.politaktiv.map.infrastructure.model.Marker deleteMarker(
		org.politaktiv.map.infrastructure.model.Marker marker)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteMarker(marker);
	}
	...
	*/
	...
	public static MarkerLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof MarkerLocalService) {
				_service = (MarkerLocalService)invokableLocalService;
			}
			else {
				_service = new MarkerLocalServiceClp(invokableLocalService);
			}
