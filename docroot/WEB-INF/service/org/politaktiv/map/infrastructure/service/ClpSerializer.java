...
public class ClpSerializer {
	...
	public static Object translateInputBackground(BaseModel<?> oldModel) {
		BackgroundClp oldClpModel = (BackgroundClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getBackgroundRemoteModel();
	...
	public static Object translateInputPicture(BaseModel<?> oldModel) {
		PictureClp oldClpModel = (PictureClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getPictureRemoteModel();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new org.politaktiv.map.infrastructure.NoSuchBackgroundException();
		}

		if (className.equals(
					"org.politaktiv.map.infrastructure.NoSuchMarkerException")) {
			return new org.politaktiv.map.infrastructure.NoSuchMarkerException();
		}

		if (className.equals(
					"org.politaktiv.map.infrastructure.NoSuchPictureException")) {
			return new org.politaktiv.map.infrastructure.NoSuchPictureException();
		}
	...
	public static Object translateOutputBackground(BaseModel<?> oldModel) {
		...
		newModel.setBackgroundRemoteModel(oldModel);
	...
	public static Object translateOutputPicture(BaseModel<?> oldModel) {
		...
		newModel.setPictureRemoteModel(oldModel);
