...
public class MapObject {
	...
	public MapObject(long mapObjectId) throws SystemException, PortalException{
		this.dbMapObject = DbMapObjectLocalServiceUtil.getDbMapObject(mapObjectId);
		this.graphicObject = new Marker(this.getGraphicObjectId());
	}
	
	public MapObject(String type) throws SystemException{
		
		//wrapped object
		this.dbMapObject = DbMapObjectLocalServiceUtil.createDbMapObject(CounterLocalServiceUtil.increment());
		
		//child object and pointer to it
		if(type.equals("marker")){
			this.graphicObject = new Marker();
		} else if(type.equals("picture")){
			this.graphicObject = new Picture();
		}
		this.setGraphicObjectId(this.graphicObject.getId());
	}
...
//////////// GETTER AND SETTER ///////////////////////////
	...
	public boolean isMarker(){
		return this.dbMapObject.getType().equals("marker");
	}
}
