...
public class MarkerLocalServiceClpInvoker {
	public MarkerLocalServiceClpInvoker() {
		...
		_methodName52 = "findMarkerByBackgroundId";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return MarkerLocalServiceUtil.addMarker((org.politaktiv.map.infrastructure.model.Marker)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return MarkerLocalServiceUtil.deleteMarker((org.politaktiv.map.infrastructure.model.Marker)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return MarkerLocalServiceUtil.updateMarker((org.politaktiv.map.infrastructure.model.Marker)arguments[0]);
		}
		...
		if (_methodName52.equals(name) &&
			...
			return MarkerLocalServiceUtil.findMarkerByBackgroundId(((Long)arguments[0]).longValue());
		}
