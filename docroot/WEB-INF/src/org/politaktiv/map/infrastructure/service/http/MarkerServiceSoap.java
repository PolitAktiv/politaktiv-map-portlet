...
public class MarkerServiceSoap {
	public static org.politaktiv.map.infrastructure.model.MarkerSoap addMarker(
		...
		try {
			org.politaktiv.map.infrastructure.model.Marker returnValue = MarkerServiceUtil.addMarker(marker,
					groupId);
	...
	public static org.politaktiv.map.infrastructure.model.Marker[] findMarkerByBackgroundId(
		...
		try {
			...
			return returnValue.toArray(new org.politaktiv.map.infrastructure.model.Marker[returnValue.size()]);
		}
		catch (Exception e) {
			_log.error(e, e);
