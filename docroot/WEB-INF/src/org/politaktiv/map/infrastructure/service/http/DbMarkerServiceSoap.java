 ...
 * {@link org.politaktiv.map.infrastructure.service.DbMarkerServiceUtil} service utility. The
 ...
 * is translated to an array of {@link org.politaktiv.map.infrastructure.model.DbMarkerSoap}.
 * If the method in the service utility returns a
 * {@link org.politaktiv.map.infrastructure.model.DbMarker}, that is translated to a
 * {@link org.politaktiv.map.infrastructure.model.DbMarkerSoap}. Methods that SOAP cannot
 ...
 *
 * @author    eichi
 * @see       DbMarkerServiceHttp
 * @see       org.politaktiv.map.infrastructure.model.DbMarkerSoap
...
public class DbMarkerServiceSoap {
	...
	private static Log _log = LogFactoryUtil.getLog(DbMarkerServiceSoap.class);
}