 ...
 * {@link org.politaktiv.map.infrastructure.service.DbPictureServiceUtil} service utility. The
 ...
 * is translated to an array of {@link org.politaktiv.map.infrastructure.model.DbPictureSoap}.
 * If the method in the service utility returns a
 * {@link org.politaktiv.map.infrastructure.model.DbPicture}, that is translated to a
 * {@link org.politaktiv.map.infrastructure.model.DbPictureSoap}. Methods that SOAP cannot
 ...
 *
 * @author    eichi
 * @see       DbPictureServiceHttp
 * @see       org.politaktiv.map.infrastructure.model.DbPictureSoap
...
public class DbPictureServiceSoap {
	...
	private static Log _log = LogFactoryUtil.getLog(DbPictureServiceSoap.class);
}