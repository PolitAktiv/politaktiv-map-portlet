...
function editViewMapInit(namespace) {
	...
	setEditBackground(pref_background_url);
	// zentriert die Karte auf das K28
	editViewMap.setCenter(new OpenLayers.LonLat(pref_saved_lon_center,
...
function setEditBackground(url) {
	...
	if (url == "map") {
		...
		var backgroundImageLayer = new OpenLayers.Layer.Image(url, url,
